...
with open(input_file,newline="", encoding="utf-8") as csvfile:
    ...
    for row in csvreader: 
        ...
        # If candidate name is found, count the times it appears and store in a list
        # Used in percent vote calculation in the print statements
        if row[2] == "Khan": 
            khan_votes +=1
        elif row[2] == "Correy":
            correy_votes +=1
...
#  # To find the winner - make a dictionary out of the two lists previously created 
candidates = ["Khan", "Correy", "Li","O'Tooley"]
votes = [khan_votes, correy_votes,li_votes,otooley_votes]

# Zip list of candidate(key) and the total votes(value) 
# Return winner using a max function of the dictionary 
