...
import csv
bankDetails = os.path.join("budget_data.csv")
...
with open(bankDetails,newline="", encoding="utf-8") as budget:
...
# Output files
bankDetails = os.path.join("bankdetails_Summary.txt")

with open(bankDetails,"w") as file:
    
# Write methods to print to bankdetails_Summary 
